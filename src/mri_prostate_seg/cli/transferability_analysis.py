"""Cross-model adversarial transferability analysis.
...
``python experiments/transferability_analysis.py --help`` and ``mri-transferability-analysis`` behave identically.
"""
...
LEGACY_PATH = "experiments/transferability_analysis.py"
