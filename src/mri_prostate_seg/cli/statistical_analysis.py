"""Statistical comparison across robustness experiments.
...
``python experiments/statistical_analysis.py --help`` and ``mri-statistical-analysis`` behave identically.
"""
...
LEGACY_PATH = "experiments/statistical_analysis.py"
